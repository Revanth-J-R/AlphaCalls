...
<head>
    ...
    <title>agent Registration Portal</title>
...
<body>
    ...
    <div class="header row justify-content-center align-items-center" style="background-color:rgb(219, 83, 52)">
        <h2 style="font-style:bold;color:white">Agent Registration<h2>
    </div>
    <main class="my-form">
        <div class="cotainer">
                        ...
                        <div class="card-body">
                            <form name="my-form" action="Register.php" method="post">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right"><b>Full
                                            Name</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right"><b>Phone
                                            Number</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address"
                                        class="col-md-4 col-form-label text-md-right"><b>Present Address</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="states"
                                        class="col-md-4 col-form-label text-md-right"><b>State</b></label>
                                    <div class="col-md-6">
                                        <select name="statevalue" id="states" onchange="state()"
                                ...
                                <div class="form-group row">
                                    <label for="states"
                                        class="col-md-4 col-form-label text-md-right"><b>District</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="p2" class="col-md-4 col-form-label text-md-right"><b>Confirm
                                            Password</b></label>
                                    <div class="col-md-6">
...
if (isset($_POST['register'])) {
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        ...
        $query = "insert into registration (agent_name,agent_phone,
                agent_address, agent_state, agent_district,agent_password) 
