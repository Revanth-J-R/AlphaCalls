...
<body>
     ...
     <div class="header">
          ...
          <div class="dropdown">
               ...
               <ul class="dropdown-menu etc">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                         ...
                         echo "<li class='options'> <a href='../auth/Login.php'><label class='makeitgreen'>Login</label></a></li>";
                    }
                    ?>
               </ul>
          </div>
          ...
          <div class="proicon">
               ...
               <?php
               if (!isset($_SESSION['phonenumber'])) {
                    echo "<a href='../auth/Login.php'> <i class='far fa-user-circle ' style='font-size:30px; color: white; padding-top:5px;'></i></a>";
               } else {
     ...
     <div class="headerdown">
          ...
          <a href="CallCenter.php" id="navbar"><i class="fa fa-phone fa-rotate-vertical"
                    aria-hidden="true"></i><label>Call Centers And Sms</label></a>
          <hr>
     </div>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                         <img class="images1" src="../Images/Website/Farmer1.jpeg" height="500px" width="1350px"
                              alt=".x.">
                         <div class="time"></div>
                    </div>
                    <div class="carousel-item active">
                         <img class="images1" src="../Images/Website/Farmer2.jpeg" height="500px" width="1350px"
                              alt="...">
                    </div>
                    <div class="carousel-item">
                         <img class="images1" src="../Images/Website/Farmer4.jpg" height="500px" width="1350px"
                              alt="...">
                    </div>
               </div>
          </div>
     ...
     <div class="pictus">
          ...
          <div class=content_item><label style="font-size :40px; text-shadow: 1px 1px 1px gray;"><b>Features</b></label>
          </div>
          ...
          <table>
               ...
               <tr>
                    <td><label class="imag1_under"><b>Fixed Price Selling</b>
                              Registered buyers can order organic products online by making online payment for the
                              product which was set by the seller</label></td>
                    </td>
                    <td><label class="imag2_under">
                              <b> Enquiry Based Buying</b>
                              Registered buyers can place enquiry of a product and eligible sellers can place their
                              quotes. The buyer can then buy from the qualified sellers </td>
                    </td>
                    <td><label class="imag3_under">
                              <b> Raising Future Demands</b>
                              Registered buyers can place their request for products which will be produced by the
                              farmers in future </td>
                    </td>
               </tr>
          </table>
     ...
     <div class="slideshow" id="showing">
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                         <img class="images1" src="../Images/Website/quote1.jpeg" height="500px" width="1350px"
                              alt=".x.">
                         <div class="time"></div>
                    </div>
                    <div class="carousel-item active">
     ...
     <div class="copy">
          <h5 style="text-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy;
               2022 by www.AgroCraft.com</h5>
     </div>
