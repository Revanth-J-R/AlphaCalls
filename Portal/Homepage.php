     ...
     <body>
          ...
          <div class="row" style="text-align:center;">
               <div class="col-md-3 col-sm-12">
                    <a href="Homepage.php" id="navbar"><i class="fa fa-home"
               ...
               <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                         <div class="carousel-item active">
                              <img class="d-block w-100 resizing" src="../Images/Homepage/fruitsbasket.jpg"
                                   alt="First slide">
                         </div>
                         ...
                         <div class="carousel-item">
                              <img class="d-block w-100 resizing" src="../Images/Homepage/vegetables.jpg"
                                   alt="Second slide">
                         </div>
          ...
          <div class="features container">
               ...
               <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                    <div class="card">
                         <p class="aligncenter">
                              <img class="card-img-top image" src="../Images/Homepage/sms.png" alt="Card image cap"
                    ...
                    <div class="card">
                         <p class="aligncenter">
                              <img class="card-img-top image" src="../Images/Homepage/handshake.png"
                                   alt="Card image cap" width="250px" height="200px">
                         </p>
                         <div class="card-body">
                    ...
                    <div class="card">
                         <p class="aligncenter">
                              <img class="card-img-top image" src="../Images/Homepage/farmer.png" alt="Card image cap"
                                   width="250px" height="200px">
                         </p>
                         <div class="card-body">
                              <h4 class="card-title font-weight-bold">Farmer Group Formation</h4>
                              <br>
                              <h5 class="card-text">Get in touch with other farmers making your own community where you
                                   can ask for help</h5>
                         </div>
                    </div>
               </div>
