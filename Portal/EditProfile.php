...
if (isset($_POST['confirm'])) {
    ...
    $query = "update agentregistration 
              set agent_phone = '$phone', agent_address = '$address',
              agent_bank = '$account', agent_state = '$state',
              agent_district = '$district'
              where agent_id 
              in (select agent_id from agentregistration 
              where agent_phone='$sessphonenumber')";
    $run = mysqli_query($con, $query);

    $_SESSION['phonenumber'] = $phone;
    echo "<script>window.open('agentProfile.php','_self')</script>";
}
?>